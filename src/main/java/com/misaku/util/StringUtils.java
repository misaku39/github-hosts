...
public class StringUtils {
    ...
    /**
     * 判断字符串是否为null或者长度为0  如 "   " 这种长度不为0返回false
     */
     ...
     * @param searchString 要搜索的字符串（不区分大小写），可以为null
     * @param replacement  要替换的字符串，可以为null
     * @param max          要替换的最大值数；如果没有最大值，则为{@code -1}
     * @param ignoreCase   如果为true，替换不区分大小写，否则区分大小写
     * @return the text with any replacements processed,
     * {@code null} if null String input
     */
     ...
     * @param open  开头
     * @param close 结尾
     * @return 任何一个为null 或者原始字符串中不包含pen/close都会返回null
     */
    public static String substringBetween(final String str, final String open, final String close) {

        // 这三个任意一个都不为null 否则返回null
    ...
    /**
     * @param str 对字符串进行trim 如果为null 返回 ""
     */
     ...
     *
     * @param str      被包裹的字符串
     * @param wrapWith 在首尾包裹的字符串
     * @return 两个任何一个为null或者长度为0 那么直接返回原字符串 str
     */
